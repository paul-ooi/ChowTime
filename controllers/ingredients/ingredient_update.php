        ...
        <?php for ($i = 0; $i < $arrayLength; $i++) : ?>
         <li class="ingred-item row ml-3 ml-md-0">
                     ...
                     <select class="form-control" name="food_id[]" id="food_id">
                         ...
                         <?php foreach ($fList as $key => $f) : ?>
                             <option value="<?php echo $f->id ?>" 
                                ...
                                <?php if (isset($_POST['updateRecipe']) && $f->id == $array[$i]->ing_id) : echo "selected"; endif ?>
                 ...
                 <div class="form-group col-sm-12 col-lg-2 ingred_form_item input-group-sm mb-md-3 mb-1">
                     ...
                     ?><?php 
                     if (isset($_POST['updateRecipe']) && $array[$i]->quantity != "") : echo number_format($array[$i]->quantity, 2, ".",","); endif 
                 ...
                 <div class="form-group col-sm-12 col-lg-3 ingred_form_item input-group-sm mb-md-3 mb-1">
                     ...
                     ?><?php
                     if (isset($_POST['updateRecipe'])) : echo $array[$i]->prep; endif 
                     ?>"
                 ...
                 <div class="form-group align-content-end col-sm-12 col-lg-1 ingred_form_item input-group-sm mb-md-3 mb-1">
                     ...
                     <?php if ((!isset($_POST['required'])) || (isset($_POST['required']) && $array['required'][$i] == "true")) : echo "checked"; endif ?>
                     <?php if ((!isset($_POST['updateRecipe'])) || (isset($_POST['updateRecipe']) && $array[$i]->required == "1")) : echo "checked"; endif ?>/>
                     ...
                     <?php if ((isset($_POST['updateRecipe']) && ($array[$i]->required == "0"))) : echo "checked"; endif ?>
                     />
                 </div>
         </li>
         <?php endfor ?>
