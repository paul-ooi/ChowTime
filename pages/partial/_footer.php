<footer class="col-12">
    <div class="row">
        <div class="col-3 align-self-center">
            ...
            <div class="footer-logo-container">
                <a href="/chowtime/index.php"><img class="mx-auto footer-logo" src="/chowtime/assets/imgs/ct-logo.png" alt="Chow Time logo - Plate with fork and knife arranged like locator marker"/></a>
            </div>
            <!-- SIGNATURE -->
            <!-- <div class="footer-logo-container">
                <a href="/chowtime/index.php"><img class="mx-auto footer-logo" src="/chowtime/assets/imgs/ct-handwritten.svg" alt="Chow Time logo - Plate with fork and knife arranged like locator marker"/></a>
            </div> -->
        </div>
        <div class="col-9">
        <!-- SITE MAP LINKS -->
    <nav class="col-sm-12 col-lg-12 mb-4">
        <ul class="nav d-flex flex-row-reverse" id=" sitemap ">
            ...
            <li><a class="nav-link" href="/chowtime/pages/createProfile.php">Create Account</a></li>
        </ul>
    </nav>
    <!-- SOCIAL MEDIA SECTION -->
    <section class="offset-lg-8 col-lg-4 d-flex flex-row-reverse" id="social-media">
        <h2 class="sr-only">Follow us on Social Media</h2>
        <div class="social" id="fbook">
            <a href="http://www.facebook.com"><img src="/chowtime/assets/icons/social-fb.svg" alt="Like and Follow us on Facebook" title="Like and Follow us on Facebook"/></a>
        </div>
    ...
    <div class="col-lg-12 d-flex flex-row-reverse">
        <small class="footer-text"><?php echo date('Y') ?> Chow Time Project - by DeeDub Team</small>
        <small class="footer-text">All images from www.Pexels.com</small>
    </div>
        </div>
</div>
</footer>
